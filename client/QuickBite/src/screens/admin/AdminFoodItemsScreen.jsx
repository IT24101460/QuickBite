...
const styles = StyleSheet.create({
    ...
    card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 14, padding: 12, marginBottom: 10, elevation: 2, alignItems: 'center' },
    itemImg: { width: 56, height: 56, borderRadius: 10, marginRight: 10 },
    itemImgPlaceholder: { width: 56, height: 56, borderRadius: 10, backgroundColor: '#FFF0E8', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
    cardInfo: { flex: 1 },
    cardName: { fontSize: 14, fontWeight: 'bold', color: '#222', marginBottom: 3 },
